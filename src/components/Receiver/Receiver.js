      ...
      <div className='sender'>
          ...
          <div className='inputRow'>
              <div className='selectRegionBox'>
                  ...
                  <SelectInputRegion id={randId} placeholderName='Выберите страну' values={values} handleChange={handleChange} requiredInput={true} svgPath='arDown' />
              </div>
              ...
              <div className='selectRegionBoxSecond'>
                  ...
                  <SelectInputRegion id={randId} placeholderName='Выберите регион' values={regions} handleChange={handleChangeRegion} requiredInput={true} svgPath='arDown' />
              </div>
              ...
              <div className='selectRegionBoxSecond'>
                  ...
                  <SelectInputRegion id={randId} placeholderName='Выберите город' values={cities} handleChange={handleChangeCities} requiredInput={true} svgPath='arDown' />
              </div>
