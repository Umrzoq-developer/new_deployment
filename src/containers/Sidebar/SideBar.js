    ...
    return (
        <div className='col-sidebar'>
            ...
            >
                ...
                <Panel
                    style={{border: 'none'}}
                    header={<div className="itemUp noColor">
                        <div className='IconDiv'>
                            <svg className='Icon'>
                        ...
                        <span className='itemCount'>22 кг</span>
                        <svg className='arrowDown'><use href="#arDown" xlinkHref="#arDown"/></svg>
                    </div>
                    }
                    key="1"
                ...
                <Panel
                    ...
                    header={
                        <div className="itemUp noColor">
                            ...
                            <p className='itemName'>Cумма сбора</p> <span className='itemCount'>$1 530</span>
                            <svg className='arrowDown'><use href="#arDown" xlinkHref="#arDown"/></svg>
                        </div>
                    }
                    key="3">
                ...
                <Panel
                    ...
                    <div className='itemColSecond'>
                        ...
                        >
                            <p className='sideItemNameSecond'>Все</p>
                        </Checkbox>
                    </div>
                ...
                <Panel
                    ...
                    <Form>
                        <Form.Item label="От">
                            <DatePicker placeholder='От' onChange={onChange}/>
                        </Form.Item>
                        <Form.Item label="До">
                            <DatePicker placeholder='До' onChange={onChange}/>
                        </Form.Item>
                    </Form>
