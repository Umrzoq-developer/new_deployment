    ...
    return (
        <>
            ...
            <InfiniteScroll
                ...
                hasMore={!loading}
                loader={ <div className='Skeleton' style={{marginBottom: '100px', position: 'absolute', zIndex: '100', justifyContent: 'center', width: '75%', marginLeft: '2%'}}>
                        <Skeleton active size='large' style={{width: '100%'}}  />
                </div>}
                threshold={30}
                style={{height: '600px'}}
            >
            ...
            {/*<div className='Skeleton' style={{marginBottom: '100px', position: 'absolute', zIndex: '100', justifyContent: 'center', width: '75%', marginLeft: '2%'}}>*/}
            {/*    <Skeleton active size='large' style={{width: '100%'}}  />*/}
            {/*</div>*/}
        </>
    );
